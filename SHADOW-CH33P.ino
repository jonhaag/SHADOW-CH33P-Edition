      ...
      if (domeStatus == 0)  // Dome is currently stopped - prepare for a future turn
        ...
        else  // Dome is not in the home position - send it back to home
        {
          ...
          if (currentMillis - automateMillis > (automateDelay * 1000)) {
            ...
            if (action > 1) {
              trigger.play(random(16, 37)); // plays from Idle & Mechanical sounds
...
//Jon Note: Repurpose this control section
        ...
        if(myPS3->getButtonPress(L1)&&myPS3->getButtonClick(CROSS))
          {
                ...
                MaestroBody.restartScript(Close_Utility_Arm);
          }
          if(myPS3->getButtonPress(L1)&&myPS3->getButtonClick(CIRCLE))
          {
                ...
                MaestroBody.restartScript(Open_Utility_Arm);
          }
        break;
      case 2:
...
void processSoundCommand(char soundCommand)
{
    ...
    switch (soundCommand) 
    {
        ...
        case '4':    
          ...
          MaestroBody.restartScript(Head_Nod_Long);
          break;
        case '5':    
          #ifdef SHADOW_DEBUG    
            output += "Sound Button ";
